<x-app-layout>
    ...
    <div class="max-w-3xl bg-white border border-gray-200 shadow-sm rounded-2xl p-8">
        <form action="{{ route('admin.articles.store') }}" method="POST" class="space-y-6 text-xs">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-2">
                    ...
                    <select id="category" name="category" required class="w-full border-gray-300 focus:border-emerald-500 focus:ring focus:ring-emerald-200 rounded-xl px-4 py-3 text-gray-850">
                        <option value="artikel">Artikel Keagamaan</option>
                        <option value="khotbah">Ringkasan Khotbah Jumat</option>
            ...
            <div class="space-y-2">
                ...
                <textarea id="content" name="content" rows="12" required placeholder="Tulis kajian rohani atau ringkasan khotbah lengkap di sini..." class="w-full border-gray-300 focus:border-emerald-500 focus:ring focus:ring-emerald-200 rounded-xl px-4 py-3 text-gray-805 leading-relaxed">{{ old('content') }}</textarea>
