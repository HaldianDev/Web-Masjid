...
<body class="bg-gradient-to-br from-emerald-950 via-emerald-900 to-green-950 text-slate-100 min-h-screen antialiased selection:bg-amber-400 selection:text-emerald-950">
    ...
    <main class="py-16">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <article class="bg-gradient-to-b from-emerald-900/40 to-emerald-950 rounded-3xl p-8 sm:p-10 border border-emerald-850 shadow-xl">
                <div class="mb-8 text-center">
                    <span class="px-4 py-1.5 rounded-full bg-emerald-800 text-xs uppercase font-bold text-amber-400 border border-amber-500/10">
                        {{ $article->category === 'khotbah' ? 'Khotbah Jumat' : 'Artikel' }}
                    </span>
                ...
                <div class="prose prose-invert max-w-none text-slate-300 leading-relaxed text-base">
                    {!! nl2br(e($article->content)) !!}
                </div>

                <div class="mt-10 pt-6 border-t border-emerald-800 text-center">
                    <a href="{{ route('home') }}#artikel" class="inline-flex items-center px-6 py-3 bg-emerald-800 hover:bg-emerald-700 text-amber-400 font-semibold rounded-full transition-colors">
